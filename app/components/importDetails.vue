...
<template>
    <form>
        ...
        <div>
            <label for="min">Niveau de zoom minimum : {{ min }}</label
            ><br />
        </div>
        <div v-if="!minSaved">
            <input
            ...
            <button id="saveMin" type="button" @click.prevent="saveMin">
                Valider le zoom minimum
            </button>
        </div>
        ...
        <div v-else>
            ...
            <div v-if="!maxSaved">
                ...
                <button id="saveMin" type="button" @click.prevent="saveMax">
                    Valider le niveau de zoom
                </button>
            </div>
        </div>
        <hr />
        <div>
            <button id="reset" type="button" @click.prevent="resetForm">
                Réinitialiser les zooms
            </button>
            <button
